	...
	<table id="table" width="600" style=" margin: 30px auto;text-align: center; border-spacing: 0px;">
		...
		<c:forEach var="board" items="${qnaUserList}">
			<tr height="70px" style="font-size: 25px;">
				...
				<td width="700px;" style="border-bottom:2px solid gray;text-align: left;"><a href="/qna/userContent?b_no=${board.b_no}" style="text-decoration: none;">${board.b_title}</a>
				</td>
		...
		<sec:authorize access="isAuthenticated()">
			<td colspan="5" style=" border-bottom: 4px solid black; border-top:  4px solid black;"><a href="/qna/userWriteView?user_id=<sec:authentication property='principal.username'/>" style="text-decoration: none;">글 작성</a></td>
		</sec:authorize>
		<sec:authorize access="isAnonymous()">
			<td colspan="5" style=" border-bottom: 4px solid black; border-top:  4px solid black;"><a href="/login" style="text-decoration: none;">글 작성</a></td>
		</sec:authorize>
		</tr>
	</table>
